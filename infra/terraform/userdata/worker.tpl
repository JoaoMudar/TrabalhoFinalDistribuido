...
# Join via IP PRIVADO FIXO do master (dentro da VPC). A presença de K3S_URL faz
# o instalador subir em modo "agent" automaticamente. O serviço do agent k3s
# fica re-tentando a conexão sozinho até o master responder.
